 ...
 */
public class Step2ShortFragment extends Fragment {

    private DismissOverlayView mDismissOverlay;
    ScrollView sv;
    TextView tv;

    public Step2ShortFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_step2_short, container, false);

        sv = (ScrollView)root.findViewById(R.id.probaScroll);

        tv = (TextView) root.findViewById(R.id.instNumber);
        String step = getString(R.string.step2TitleText);
                    ...
                    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                        ...
                        try {
                            ...
                            if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE
                                ...
                                //next step
                                Step3ShortFragment s3f = new Step3ShortFragment();
