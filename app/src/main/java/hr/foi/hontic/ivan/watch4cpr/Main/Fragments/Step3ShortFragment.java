 ...
 */
public class Step3ShortFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_step3_short, container, false);

        sv = (ScrollView)root.findViewById(R.id.probaScroll);

        tv = (TextView) root.findViewById(R.id.instNumber);
        String step = getString(R.string.step3TitleTextShort);
                    ...
                    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                        ...
                        try {
                            ...
                            if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE
                                ...
                                //next step
                                Step4ShortFragment s3f = new Step4ShortFragment();
                                ...
                                transaction.commit();
                                    ...
                                    && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                                //previous step
                                Step2ShortFragment s1f = new Step2ShortFragment();
